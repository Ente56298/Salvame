...
const RealTimeTracking: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const mockServices: ServiceProvider[] = [
      ...
      },
      {
        ...
        price: 800,
        rating: 4.8,
        location: { lat: 19.4350, lon: -99.1300 }
      },
      {
        id: '3',
        ...
        price: 150,
        rating: 4.2,
        location: { lat: 19.4280, lon: -99.1380 }
      },
      {
        id: '4',
        ...
        price: 24,
        rating: 4.0,
        location: { lat: 19.4340, lon: -99.1320 }
      }
    ];
  ...
  const getStatusText = (status: ServiceProvider['status']) => {
    switch (status) {
  ...
  const handleTrackService = (service: ServiceProvider) => {
